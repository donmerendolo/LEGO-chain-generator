...
const STRINGS = {
  en: {
    ...
    tooLoose: 'That is slack. These wheels want {n} links.',
    tooTight: 'That is tight. These wheels want {n} links.',
  ...
  es: {
    ...
    tooLoose: 'Así va floja. Estas ruedas piden {n} eslabones.',
    tooTight: 'Así va tirante. Estas ruedas piden {n} eslabones.',
